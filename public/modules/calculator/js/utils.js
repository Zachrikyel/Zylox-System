...
function calculateQuote(params) {
  ...
  return {
    ...
    breakdown: {
      ...
      suppliesDetail: {
        primer: getTieredCost(labor.primerToggle, SYSTEM_CONFIG.PRIMER_COST),
        lacquer: getTieredCost(labor.lacquerToggle, SYSTEM_CONFIG.LACQUER_COST),
        sanding: getTieredCost(labor.sandingToggle, SYSTEM_CONFIG.SANDING_COST),
        paint: getTieredCost(labor.paintToggle, SYSTEM_CONFIG.PAINT_COST),
        magnets: getTieredCost(logistics.additionalsToggle, SYSTEM_CONFIG.EXTRAS_FLAT_COST),
        brush: getTieredCost(labor.brushToggle, SYSTEM_CONFIG.BRUSH_COST),
        superglue: getTieredCost(labor.superglueToggle, SYSTEM_CONFIG.SUPERGLUE_COST),
