...
const ZYLOX_CONFIG = {
    ...
    tools: [
        ...
        { id: 'accounts', name: 'Cuentas', icon: 'wallet', color: 'holo', file: 'accounts.html' }
    ]
};
...
const ICONS = {
    ...
    wallet: '<path d="M3 7a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7zm14 4a1 1 0 100 2 1 1 0 000-2z"/><path d="M3 7l9-4 9 4"/>'
};
